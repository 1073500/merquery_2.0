        ...
        <div class="">
            <form action="{{ route('contents.index') }}" method="GET">
                <input
                    ...
                    name="search"  placeholder="Search title"></input>
                <button
                ...
                <a href="{{ route('contents.index') }}" class="border border-blue-600 bg-g p-2 m-2 rounded-full inline-flex items-center px-6 text-sm font-medium leading-5 text-gray-500 hover:text-white hover:duration-300 ease-in hover:bg-blue-600 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none">Show all</a>
            </form>
        </div>
    </div>
</div>
