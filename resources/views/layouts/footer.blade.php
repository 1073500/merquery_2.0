    ...
    <div class="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
            ...
            <div class="group">
                <div class="flex items-center space-x-2 mb-6">
                    <div
                        class="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center transform group-hover:rotate-12 transition duration-500">
                        <span class="text-xl font-bold">x</span>
                    </div>
                    <h2 class="text-2xl font-bold bg-clip-text text-transparent text-white">
                        Merquery
                    </h2>
                </div>
                <p class="text-gray-300 mb-6">lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam,
                    quod.</p>
                ...
                <div class="flex space-x-4">
                    <a href="#"
                       class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-900 transition-all duration-300">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="x"
                               class="text-white hover:text-blue-400 transition">merquery@hr.nl</a>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
        ...
        <div class="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm mb-4 md:mb-0">
                &copy; <span id="year" class="text-blue-400"></span> Merquery 2025. All rights reserved.
            </p>
